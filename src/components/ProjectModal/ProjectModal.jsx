      ...
      >
        ...
        <div className="p-6 flex flex-col gap-4">
            ...
            <a
                ...
                className="mt-4 inline-flex items-center justify-center gap-2 font-semibold bg-blue-700 p-3 px-5 rounded-full w-full cursor-pointer border border-transparent hover:bg-blue-900 transition-colors"
            >
                <FiGithub />
